  ...
  Future getUsers() async {
    try {
      http.Response hasil = await http.get(
          Uri.parse("http://10.0.2.2/user_api/list.php"),
  ...
  Future deleteUser(String id) async {
    ...
    try {
      http.Response hasil = await http.post(
          Uri.parse("http://10.0.2.2/user_api/delete.php"),
          headers: {"Accept": "application/json"},
...
// print("error catch $e");
  ...
  Future createUser(String name, String email, String password) async {
    ...
    try {
      http.Response hasil = await http.post(
          Uri.parse("http://10.0.2.2/user_api/create.php"),
          headers: {"Accept": "application/json"},
          body: json.encode(data));
      if (hasil.statusCode == 200) {
        return true;
...
// print("error catch $e");
  ...
  Future editUser(String id, String name, String email, String password) async {
    ...
    try {
      http.Response hasil = await http.post(
          Uri.parse("http://10.0.2.2/user_api/update.php"),
          headers: {"Accept": "application/json"},
          body: json.encode(data));
      if (hasil.statusCode == 200) {
        return true;
